#############################################################################
# Makefile for building: MC_2D_NVT-FE_HCM
# Generated by qmake (3.0) (Qt 5.0.2) on: Tue Sep 8 12:49:07 2015
# Project:  MC_2D_NVT-FE_HCM.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile MC_2D_NVT-FE_HCM.pro
#############################################################################
...
OBJECTS       = MTGenerator.o \
		MC-NVT_2D_FreeEnergies_HardMultimers.o
DIST          = /usr/share/qt5/mkspecs/features/spec_pre.prf \
		...
		MC_2D_NVT-FE_HCM.pro \
		MC_2D_NVT-FE_HCM.pro
QMAKE_TARGET  = MC_2D_NVT-FE_HCM
DESTDIR       = 
...
Makefile: MC_2D_NVT-FE_HCM.pro /usr/share/qt5/mkspecs/linux-g++-64/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile MC_2D_NVT-FE_HCM.pro
...
dist: 
	@test -d .tmp/MC_2D_NVT-FE_HCM1.0.0 || mkdir -p .tmp/MC_2D_NVT-FE_HCM1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/MC_2D_NVT-FE_HCM1.0.0/ && $(COPY_FILE) --parents MTGenerator.h .tmp/MC_2D_NVT-FE_HCM1.0.0/ && $(COPY_FILE) --parents MTGenerator.cpp MC-NVT_2D_FreeEnergies_HardMultimers.cpp .tmp/MC_2D_NVT-FE_HCM1.0.0/ && (cd `dirname .tmp/MC_2D_NVT-FE_HCM1.0.0` && $(TAR) MC_2D_NVT-FE_HCM1.0.0.tar MC_2D_NVT-FE_HCM1.0.0 && $(COMPRESS) MC_2D_NVT-FE_HCM1.0.0.tar) && $(MOVE) `dirname .tmp/MC_2D_NVT-FE_HCM1.0.0`/MC_2D_NVT-FE_HCM1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/MC_2D_NVT-FE_HCM1.0.0
...
MC-NVT_2D_FreeEnergies_HardMultimers.o: MC-NVT_2D_FreeEnergies_HardMultimers.cpp MTGenerator.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MC-NVT_2D_FreeEnergies_HardMultimers.o MC-NVT_2D_FreeEnergies_HardMultimers.cpp
