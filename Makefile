...
# Template: app
# Command: /home/mbilly/Qt5.7.0/5.7/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile MC_2D_NpT-VS_HCM.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = MC_2D_NpT-VS_HCM1.0.0
DISTDIR = /home/mbilly/Programy/MC_2D_NpT-VS_HCM/.tmp/MC_2D_NpT-VS_HCM1.0.0
LINK          = g++
...
DIST          = ../../Qt5.7.0/5.7/gcc_64/mkspecs/features/spec_pre.prf \
		...
		MC_2D_NpT-VS_HCM.pro MTGenerator.h MTGenerator.cpp \
		MC-NpT_2D_VariableBoxShape_HardMultimers.cpp
...
Makefile: MC_2D_NpT-VS_HCM.pro ../../Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++/qmake.conf ../../Qt5.7.0/5.7/gcc_64/mkspecs/features/spec_pre.prf \
		../../Qt5.7.0/5.7/gcc_64/mkspecs/common/unix.conf \
		../../Qt5.7.0/5.7/gcc_64/mkspecs/common/linux.conf \
		../../Qt5.7.0/5.7/gcc_64/mkspecs/common/sanitize.conf \
		../../Qt5.7.0/5.7/gcc_64/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile MC_2D_NpT-VS_HCM.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents MTGenerator.cpp MC-NpT_2D_VariableBoxShape_HardMultimers.cpp $(DISTDIR)/
